isboxer.Character.Name = "Puzzir-Herod";
isboxer.Character.ActualName = "Puzzir";
isboxer.Character.QualifiedName = "Puzzir-Herod";
...
isboxer.Output("Character 'Puzzir-Herod' activated");
