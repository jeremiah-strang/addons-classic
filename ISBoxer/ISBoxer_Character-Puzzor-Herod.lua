isboxer.Character.Name = "Puzzor-Herod";
isboxer.Character.ActualName = "Puzzor";
isboxer.Character.QualifiedName = "Puzzor-Herod";
...
isboxer.Output("Character 'Puzzor-Herod' activated");
