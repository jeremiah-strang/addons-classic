isboxer.Character.Name = "Puzzer-Herod";
isboxer.Character.ActualName = "Puzzer";
isboxer.Character.QualifiedName = "Puzzer-Herod";
...
isboxer.Output("Character 'Puzzer-Herod' activated");
