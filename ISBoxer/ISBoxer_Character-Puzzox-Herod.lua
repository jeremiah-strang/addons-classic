isboxer.Character.Name = "Puzzox-Herod";
isboxer.Character.ActualName = "Puzzox";
isboxer.Character.QualifiedName = "Puzzox-Herod";
...
isboxer.Output("Character 'Puzzox-Herod' activated");
