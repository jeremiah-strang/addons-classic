...
local auras_default = {
	["auras_visible"] = { -- ListName, DisplayName, Shown/Hidden, Count/Ignore, Blacklist/Whitelist, BuffType, Buff/Debuff
		...
		[12179] = {"Scroll of Strength IV", "Scroll of Strength IV", BCT.HIDE, BCT.COUNT, BCT.WHITELISTED, BCT.CONSUMABLE, BCT.BUFF},
		[12174] = {"Scroll of Agility IV", "Scroll of Agility IV", BCT.HIDE, BCT.COUNT, BCT.WHITELISTED, BCT.CONSUMABLE, BCT.BUFF},
		[15233] = {"Crystal Ward", "Crystal Ward", BCT.HIDE, BCT.COUNT, BCT.WHITELISTED, BCT.CONSUMABLE, BCT.BUFF},
		[15279] = {"Crystal Spire", "Crystal Spire", BCT.HIDE, BCT.COUNT, BCT.WHITELISTED, BCT.CONSUMABLE, BCT.BUFF},
