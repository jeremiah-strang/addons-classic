...
L["send_to_guild_desc"] = "Sende den Verlauf an Gildenmitglieder anstatt an deine Gruppe. Nützlich, wenn mehrere Schlachtzugsgruppen aktiv sind und du einen kombinierten Verlauf für deine Gilde wünschst. Der Nachteil ist, dass Nicht-Gildenmitglieder in Ihrer Gruppe Ihre Verlaufseinträge nicht registrieren."
...
L["Standard JSON output."] = "JSON-Array mit einem JSON-Objekt pro Verlaufseintrag."
